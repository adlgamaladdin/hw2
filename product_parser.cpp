...
{
    Product* prod1 = new Book(prodName_, price_, qty_, isbn_, author_);
    return prod1;
}
...
{
    Product* prod1 = new Clothing(prodName_, price_, qty_, size_, brand_);
    return prod1;
}
...
{
    Product* prod1 = new Movie(prodName_, price_, qty_, genre_, rating_);
    return prod1;
}
